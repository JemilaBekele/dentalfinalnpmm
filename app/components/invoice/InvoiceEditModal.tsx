...
import { Invoice, InvoiceItem, Service } from "@/types/invotwo"; // Adjust the path accordingly
...
const InvoiceEditModal: React.FC<InvoiceEditModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-lg w-full relative z-10 overflow-y-auto h-272">
